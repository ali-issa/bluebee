...
function StickyWordsComponent() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full min-h-svh text-center text-[clamp(1.6rem,3.45vw,4rem)] leading-tight bg-gradient-to-b from-primary to-transparent overflow-x-clip"
    >
...
export const StickyWords = memo(StickyWordsComponent)
